...
class BidDetailService {
  ...
  static final Map<String, BidDetailModel> _mockDetails = {
    ...
    '8': const BidDetailModel(
      id: '8',
      projectTitle: 'Sahab Business Center',
      companyName: 'Sahab Development',
      status: 'guaranteeIssued',
      sector: 'Commercial',
      location: 'Sahab, Amman',
      contractValue: 44000,
      timelineRange: '6 months (Aug 2026 – Feb 2027)',
      bidAmount: 43500,
      projectId: 'TRV-PRJ-91027',
      milestones: 'Fit-out – M2, MEP – M4, Handover – M6',
      guaranteeTypeRequired: 'Performance Guarantee',
      paymentTerms: '20% upfront / 60% milestones / 20% completion',
      statusSteps: [
        StatusStepModel(label: 'Bid Submitted', date: 'Jul 1, 2026', state: BidStepState.completed),
        StatusStepModel(label: 'Selected by Owner', date: 'Jul 6, 2026', state: BidStepState.completed),
        StatusStepModel(label: 'Confirmed', date: 'Jul 8, 2026', state: BidStepState.completed),
        StatusStepModel(label: 'Guarantee Applied', date: 'Jul 12, 2026', state: BidStepState.completed),
        StatusStepModel(label: 'Guarantee Issued by Bank', date: 'Jul 20, 2026', state: BidStepState.current),
        StatusStepModel(label: 'Owner Confirmation → Active', state: BidStepState.pending),
      ],
    ),
